...
Thank you for registering with TRUST Customer Managemen<br /><br />
To activate the service, please click the link below to verify your email address.<br />
    ( It is valid for 30 minutes from the issue.)<br /><br />
    <a target="_blank" href="{{$verificationUrl}}">{{$verificationUrl}}</a><br /><br />
